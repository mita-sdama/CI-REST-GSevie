...
class Alamat extends REST_Controller {
 // Konfigurasi letak folder untuk upload image
    ...
    {
      $id_alamat = $this->post('id_alamat');
      $alamatDisable = $this->db->query("SELECT sewa.id_alamat FROM sewa JOIN alamat ON alamat.id_alamat=sewa.id_alamat JOIN detail ON detail.id_sewa = sewa.id_sewa  WHERE sewa.id_alamat='$id_alamat' AND detail.status_detail<>'kembali'")->result(); 
